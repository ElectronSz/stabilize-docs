          ...
          <Card className="border-accent/20 bg-card/50 backdrop-blur-sm">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                One API covers four databases. Set <code>type</code> and supply
...
export { User };`}
              ...
              <p className="text-sm text-muted-foreground mt-4">
                ...
                deliberate: it behaves identically on all four databases. An{" "}
                <code>INTEGER</code> <code>id</code> is instead generated by the
                database and must be omitted from the payload, which on SQL
                Server means an <code>IDENTITY</code> column that rejects an
                explicit value — see{" "}
                <a className="underline" href="/docs/mssql">
                  SQL Server
                </a>
                . Either works on every dialect; just be consistent about who
                assigns the key.
              </p>
            </CardContent>
          </Card>
